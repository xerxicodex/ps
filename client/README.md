...
- integrate seamlessly with other [`@nxpkmn`](https://pkmn.cc/@nxpkmn/) projects
...
- numerous fields and their types have been renamed / rearranged / coalesced / tightened to better
  match the `@nxpkmn/sim` representations and the types required by other `@nxpkmn` projects.
