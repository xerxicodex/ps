import { NPCPokemon, PokemonColorEnumType, PokemonGenderEnumType, RoutePokemon, TowerPokemon, TrainerPokemon } from "@prisma/client";
...
export const ParsePokemonFullName = (
