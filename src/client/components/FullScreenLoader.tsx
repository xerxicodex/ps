  ...
  return (
    <div
      ...
      className={classNames(
        "fullscreen-loader fixed inset-0 flex items-center justify-center bg-slate-800/75 transition-all animate__animated animate__fast",
        blocking ? "" : "pointer-events-none",
        props.hide
          ? "animate__fadeOut backdrop-blur-none"
          : "animate__fadeIn backdrop-blur-sm"
      )}
      style={{ zIndex: 10000 }}
    >
