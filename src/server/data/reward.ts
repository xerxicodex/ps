...
import { GetTrainerById, GiveTrainerBattlePoints, GiveTrainerCoins, GiveTrainerExp, GiveTrainerItem, GiveTrainerMainPokemonEXP, GiveTrainerPokemon, GiveTrainerPokemonEXP, GiveTrainerRewardPokemon } from "./trainer";
...
export async function GiveRewardToTrainer(reward_id: number, trainer_id: number): Promise<any> {
    ...
    if (reward) {
        ...
        if (trainer) {
            let func: any = ({
                ...
                [RewardEnumType.pokemon]: GiveTrainerRewardPokemon,
